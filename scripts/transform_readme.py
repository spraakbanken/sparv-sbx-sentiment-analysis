...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/sparv-sbx-sentiment-kb-sent.svg",
            f"https://img.shields.io/pypi/v/sparv-sbx-sentiment-kb-sent/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/l/sparv-sbx-sentiment-kb-sent.svg",
            f"https://img.shields.io/pypi/l/sparv-sbx-sentiment-kb-sent/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/pyversions/sparv-sbx-sentiment-kb-sent.svg",
            f"https://img.shields.io/pypi/pyversions/sparv-sbx-sentiment-kb-sent/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/status/sparv-sbx-sentiment-kb-sent.svg",
            f"https://img.shields.io/pypi/status/sparv-sbx-sentiment-kb-sent/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/sparv-sbx-sentiment-kb-sent/blob/{version}/README.md",
                url,
            )
        return f"]({url})"
